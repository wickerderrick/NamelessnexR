package com.namelessnex.org

object AppConfig {
    const val ANG_PACKAGE                        = "com.namelessnex.org"
    // legacy
    ...
    const val PREF_SUB_AUTO_UPDATE_ENABLED        = "pref_sub_auto_update_enabled"
    const val PREF_AUTO_TEST_ENABLED              = "pref_auto_test_enabled"
    const val PREF_SPEED_FIX_ENABLED              = "pref_speed_fix_enabled"
    const val PREF_N_S_P_ENABLED                  = "pref_notification_switch_profile_enabled"
    const val PREF_SUB_GROUP_ENABLED              = "pref_sub_group_enabled"
    ...
    const val UDP_PROTOCOL   : String             = ""

    const val BROADCAST_ACTION_SERVICE            = "com.namelessnexR.trojan.action.service"
    const val BROADCAST_ACTION_ACTIVITY           = "com.namelessnexR.trojan.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK       = "com.namelessnexR.trojan.action.widget.click"
    ...
    const val GOOGLE_DNS_ALT                      = "8.8.0.0"
    ...
    const val MSG_REALTIME_TRAFFIC                = 67
